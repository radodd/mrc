export const santaPaulaMaterials = [
  {
    ...
    desc: "At Santa Paula Materials, we take pride in our recycling efforts, which are a key part of our commitment to sustainability. We process a variety of construction and demolition debris, transforming waste materials like concrete, asphalt, and other aggregates into high-quality recycled products. This not only reduces landfill waste but also conserves natural resources. Our recycling services help clients minimize their environmental impact while providing them with reliable materials for their projects. We strive to make recycling accessible and beneficial for everyone involved, ensuring a greener future for our community.",
  },
  {
    id: 2,
    ...
    // image: "/image 136.svg",
    name: "C & D Demolition",
    desc: "At MRC Rock and Sand, we offer comprehensive construction and demolition (C&D) services that focus on efficient site clean-up and material recovery. Our team specializes in safely dismantling structures and managing the debris generated from these projects. We prioritize recycling and reclaiming valuable materials, ensuring that as much as possible is repurposed rather than sent to landfills. We’re committed to providing a smooth, efficient experience for our clients while promoting sustainability in every project we undertake.",
  },
];

export const mrcRocknSand = [
  {
    id: 1,
    image: "/RockReclamation.png",
    name: "Rock Reclamation",
    desc: "At MRC Rock and Sand, we specialize in rock reclamation, a process that allows us to recover and repurpose valuable materials from construction and demolition sites. We take great care to sort and process various types of rock and aggregate, transforming them into usable products for future projects. This not only helps reduce waste in landfills but also conserves natural resources, making it a sustainable choice for our clients. Our rock reclamation services ensure that high-quality materials are available for construction and landscaping while promoting environmentally responsible practices. We’re proud to play a part in creating a more sustainable future for our community.",
  },
  {
    id: 2,
    image: "/Crushing&Screening.png",
    name: "Crushing & Screening",
    desc: "At MRC Rock and Sand, we provide comprehensive crushing and screening services that are essential for processing raw materials efficiently. Our mobile units can be transported directly to your project site, allowing us to deliver onsite services tailored to your needs. During the crushing process, we break down large materials into smaller, manageable pieces. Then, through screening, we separate these materials into various sizes and grades. This ensures that you receive the right materials for your project, maximizing both quality and efficiency. We’re dedicated to helping you achieve the best results while minimizing waste and maximizing productivity.",
  },
];
