...
CustomNavigationMenuContent.displayName =
...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center justify-center rounded-md px-1 py-0 text-2xl font-normal transition-colors text-accent-foreground hover:font-bold focus:font-bold focus:outline-none  disabled:opacity-50 data-[active]:bg-tanbase data-[state=open]:font-normal",
);
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ref={ref}
    className={cn(
      "flex flex-col items-center justify-center data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out data-[motion^=from-]:fade-in data-[motion^=to-]:fade-out data-[motion=from-end]:slide-in-from-right-52 data-[motion=from-start]:slide-in-from-left-52 data-[motion=to-end]:slide-out-to-right-52 data-[motion=to-start]:slide-out-to-left-52 md:absolute md:w-auto ",
      className,
    )}
    {...props}
  />
